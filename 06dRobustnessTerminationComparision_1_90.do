...
{\*\expandedcolortbl;;}
\margl1440\margr1440\vieww28340\viewh15900\viewkind0
...
* Foster, \'93Subject to Change: Quantifying Transformation in Armed Conflict Actors\'94\
* This file compares inclusion criteria for minimum numbers of articles per group/year\
* Includes a replication of\
* \'93The Intractability of Islamist Insurgencies: Islamist Rebels and the Recurrence of Civil War"\
* Desir\'e9e Nilsson & Isak Svensson, International Studies Quarterly\
***************************************************************************************************/\
\
clear all\
\
...
use "/Users/Promachos/Dropbox (Personal)/TransformationEmpiricalModels/Replication/STC_Replication/data/terminationplus_1_90.dta"\
\
sort dyadid year\
\
************************************************\
...
\cf0 coefplot(RepModel, label(Replication))(SmallChange, label(Low Change))(MedChange, label(Med. Change))(HighChange, label(High Change)), drop(_cons) xline(0) graphregion(color(white)) bgcolor(white) title("N = 1, T=90\'94)\
graph export \'93/Users/Promachos/Dropbox (Personal)/TransformationEmpiricalModels/Replication/STC_Replication/thresh_1_90.pdf\'94, as(pdf) name("Graph") replace\
\pard\tx720\tx1440\tx2160\tx2880\tx3600\tx4320\tx5040\tx5760\tx6480\tx7200\tx7920\tx8640\pardirnatural\qj\partightenfactor0
\cf0 \
}