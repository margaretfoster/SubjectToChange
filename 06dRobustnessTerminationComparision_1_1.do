...
{\*\expandedcolortbl;;}
\margl1440\margr1440\vieww30040\viewh15600\viewkind0
\pard\tx720\tx1440\tx2160\tx2880\tx3600\tx4320\tx5040\tx5760\tx6480\tx7200\tx7920\tx8640\pardirnatural\partightenfactor0

\f0\fs36 \cf0 clear all\
****************************************************************************************************\
		\
...
Desir\'e9e Nilsson & Isak Svensson\
...
use "/Users/Promachos/Dropbox (Personal)/TransformationEmpiricalModels/Replication/STC_Replication/data/terminationplus_1_1.dta"\
\
sort dyadid year\
\
************************************************\
...
set scheme lean2 \
\
** Appendix Comparison Figure ** \
coefplot(RepModel, label(Replication))(SmallChange, label(Low Change))(MedChange, label(Med. Change))(HighChange, label(High Change)), drop(_cons) xline(0) graphregion(color(white)) bgcolor(white) title("N = 1, T=100\'94)\
graph export \'93/Users/Promachos/Dropbox (Personal)/TransformationEmpiricalModels/Replication/STC_Replication/thresh_1_1.pdf\'94, as(pdf) name("Graph") replace\
}