...
use "/Users/Promachos/Dropbox (Personal)/TransformationEmpiricalModels/Replication/STC_Replication/data/terminationplus_10_1.dta"\
\
sort dyadid year\
\
************************************************\
...
\cf0 coefplot(RepModel, label(Replication))(SmallChange, label(Low Change))(MedChange, label(Med. Change))(HighChange, label(High Change)), drop(_cons) xline(0) graphregion(color(white)) bgcolor(white) title("N = 10, T= 100\'94)\
graph export \'93/Users/Promachos/Dropbox (Personal)/TransformationEmpiricalModels/Replication/STC_Replication/thresh_10_1.pdf\'94, as(pdf) name("Graph") replace\
\pard\tx720\tx1440\tx2160\tx2880\tx3600\tx4320\tx5040\tx5760\tx6480\tx7200\tx7920\tx8640\pardirnatural\qj\partightenfactor0
\cf0 \
}